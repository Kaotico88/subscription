package com.gudmundsson.subscription.util.exception.response;
...
import com.gudmundsson.subscription.util.exception.response.custom.CustomBadRequestException;
import com.gudmundsson.subscription.util.exception.response.custom.CustomNotFoundException;
import com.gudmundsson.subscription.util.exception.response.custom.CustomRuntimeException;
import com.gudmundsson.subscription.util.exception.response.custom.XErrorResponse;
